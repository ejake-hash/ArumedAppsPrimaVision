    ...
    private function seedTodayVisit(Patient $patient, $employee, DoctorSchedule $sched, array $prof, ?string $insurerId, $procedures, $medications, ?DiagnosticTestType $penunjang): void
    {
        ...
        DoctorExamination::firstOrCreate(
            ...
            [
                ...
                'slitlamp_notes' => 'Konjungtiva tenang, kornea jernih. Lensa keruh.',
                // Segmen: HANYA enum valid 'Normal'/'Tidak Normal'/'Tidak Dapat Dinilai'
                // (divalidasi DokterController::segmenRules in:). Lensa katarak -> Tidak Normal.
                ...
                'sa_lensa_od'  => 'Tidak Normal', 'sa_lensa_os'  => 'Tidak Normal',
