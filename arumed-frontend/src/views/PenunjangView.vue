              ...
              >
                ...
                <div class="q-info">
                  ...
                  <div class="q-tags">
                    ...
                    <span v-if="q.visit?.bpjs_antrean_number" class="pill" style="background:#e0f2fe;color:#075985" :title="`No. Antrean JKN (Mobile JKN): ${q.visit.bpjs_antrean_number}`">
                      JKN {{ q.visit.bpjs_antrean_number }}
                    </span>
