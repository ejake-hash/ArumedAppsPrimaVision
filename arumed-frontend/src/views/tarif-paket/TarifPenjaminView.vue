...
.tpv-head h2 { font-family: 'DM Serif Display', serif; font-size: 20px; color: var(--td); margin: 0; }
...
.tpv-btn-ghost:hover { background: var(--bs); color: var(--gd); border-color: var(--ga); }
...
.tpv-chip:hover { background: var(--gl); border-color: var(--ga); color: var(--gd); }
...
.tpv-icon-btn:hover { background: var(--gl); color: var(--gd); border-color: var(--ga); }
...
.tpv-confirm h3 { font-family: 'DM Serif Display', serif; font-size: 18px; color: var(--td); margin: 0; }
