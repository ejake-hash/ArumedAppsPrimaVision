...
const MODULE_META = {
  ...
  tarif_paket:       'Master tarif tindakan, paket bedah & kategori tagihan (halaman Tarif & Paket).',
  ...
  master_data:       'Master data: profil institusi, ICD-10/9, penjamin, opsi refraksi, nomor dokumen & template form RM.',
