              ...
              >
                ...
                <div class="q-info">
                  ...
                  <div class="q-tags">
                    ...
                    <span v-if="!p.paketBedah" class="pill pill-no-paket" title="Paket bedah belum ditetapkan — pilih pasien lalu tetapkan paket di tab Paket Pasien (Tambah Paket)">
                      <svg viewBox="0 0 24 24" class="pill-icon"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>
                      Belum ada paket
                    </span>
          ...
          <div v-else-if="tab === 'intraop'" class="bd-intraop">
            ...
            <div class="bd-2col">
              <!-- Komponen Paket Pasien (snapshot) — edit Tindakan & BHP.
                   bd-card-combo: izinkan dropdown picker (absolute) keluar kartu (bd-card
                   default overflow:hidden → list pencarian terpotong). -->
...
.pill-no-paket  { background: #fff7ed; color: #9a3412; border: 1px solid #fdba74; font-weight: 700; }
.pill-no-paket .pill-icon { fill: none; stroke: currentColor; stroke-width: 2; }
