<script setup>
/**
 * _StubView — placeholder sementara untuk view master data yang belum dibangun.
 * Akan diganti per resource di poin 7-8.
 */
...
<template>
  <div class="stub">
    ...
    <h2>{{ title }}</h2>
    <p>Halaman ini sedang dalam pengembangan. Akan diisi pada tahap berikutnya.</p>
  </div>
</template>
